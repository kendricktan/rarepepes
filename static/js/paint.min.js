var canvasElem = document.getElementById('canvas_draw');
...
background.src = 'https://i.imgur.com/P5L9Bte.png';
...
$('#canvas_draw').mouseup(function(e){
  paint = false;
});

$('#canvas_draw').mouseleave(function(e){
  paint = false;
});
